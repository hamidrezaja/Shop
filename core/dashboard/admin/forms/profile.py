...
class AdminProfileEditForm(forms.ModelForm):
    ...
    class Meta:
        model=Profile
        fields=['first_name','last_name','phone_num','image']
        widgets = {
    ...
    def __init__(self,*args, **kwargs ):
        ...
        self.fields['phone_num'].widget.attrs['class']='js-input-mask form-control'
        self.fields['phone_num'].widget.attrs['placeholder']='09121234567'
